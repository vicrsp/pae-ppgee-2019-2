...
sample.all.eda <- sample.all %>% filter(instance == 98 | instance == 50 | instance == 6)
```
...
sample.all.dim.4.algo1 <- sample.all.eda %>% filter(algorithm == 1 & instance  == 6)
sample.all.dim.4.algo2 <-  sample.all.eda %>% filter(algorithm == 2 & instance == 6)
...
sample.all.dim.100.algo1 <- sample.all.eda %>% filter(algorithm == 1 & instance == 98)
sample.all.dim.100.algo2 <- sample.all.eda %>% filter(algorithm == 2 & instance == 98)
...
sw.test.result[1,] <- c(shapiro.test(sample.all.dim.4.algo1$result)$p.value,1,6)
sw.test.result[2,] <- c(shapiro.test(sample.all.dim.4.algo2$result)$p.value,2,6)
...
sw.test.result[5,] <- c(shapiro.test(sample.all.dim.100.algo1$result)$p.value,1,98)
sw.test.result[6,] <- c(shapiro.test(sample.all.dim.100.algo2$result)$p.value,2,98)
