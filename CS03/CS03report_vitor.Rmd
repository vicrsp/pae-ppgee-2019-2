...
if(!file.exists('CS03data_ea_dim2.csv')){
  ...
  sample.config1.dim2 <- sample.all.dim2[which(sample.all$config == 'config1'),]
  sample.config2.dim2 <- sample.all.dim2[which(sample.all$config == 'config2'),]
  }
...
if(!file.exists('CS03data_ea_dim15.csv')){
  ...
  sample.config1.dim15 <- sample.all.dim15[which(sample.all$config == 'config1'),]
  sample.config2.dim15 <- sample.all.dim15[which(sample.all$config == 'config2'),]
}
