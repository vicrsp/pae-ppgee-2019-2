...
```{r effects_mpc_ener_turma, echo = FALSE,  fig.width=7,fig.height=4, fig.align='center'}
mcp.ener <- glht(anv.ener, linfct = mcp(turma = "Tukey"))
#summary(mcp.quim)
plot(mcp.ener)
```
...
```{r effects_mpc_ener_material, echo = FALSE,  fig.width=7,fig.height=4, fig.align='center'}
mcp.ener <- glht(anv.ener, linfct = mcp(material = "Tukey"))
#summary(mcp.quim)
plot(mcp.ener)
```
