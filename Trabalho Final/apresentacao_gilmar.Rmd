...
## Planejamento do Experimento | Objetivo do Experimento {.smaller}

O objetivo do experimento é comparar o desempenho de 4 turmas em relação ao consumo de oxigênio do processo, considerando também 9 diferentes materiais (tipos de aço) produzidos para a comparação.
...
$(\tau\beta)_{ij}$ : efeito da iteração da turma $i$ com o material $j$;
